/**
 * Type definitions for Todo Generation and Progress Tracking System
 * Comprehensive interfaces for enhanced Supercollider functionality
 */

// Re-export core interfaces from dataInjector for convenience
export {
  TodoItem,
  SubtaskTodoList,
  TaskComplexity,
  ...
  CheckpointMarker
} from '../../core/utils/dataInjector';

// Re-export progress parser interfaces
export {
  ProgressUpdate,
  ParsedCheckpoint,
  ProgressParserConfig
} from '../../server/core/utils/progressParser';

// Re-export WebSocket interfaces
export {
  WebSocketMessage,
  ClientSubscription,
  BroadcastConfig
} from '../../server/websocket/progressBroadcaster';

// Extended todo generation interfaces
...
// API interfaces for client-server communication
...
export interface WorkflowEvent {
  ...
  workflowId: string;
  timestamp: number;
  executionState: any; // Reference to EnhancedExecutionState
}
...
// Pagination interface for large data sets
...
// Configuration union types for easy imports
export type AllConfigs = 
  | ProgressTrackingConfig 
  | BroadcastConfig 
  | TodoGenerationSettings 
...
export const TODO_GENERATION_VERSION = '1.0.0';
